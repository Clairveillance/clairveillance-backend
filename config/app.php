...
return (array) [
    ...
    */
    ...
    'api_version' => (string) env('API_VERSION', 'v1'),
    ...
    */
    ...
    'web_version' => (string) env('WEB_VERSION', 'v1'),
    ...
    */
    ...
    |--------------------------------------------------------------------------
    |
    | This locale will be used in AppServiceProvider to listen to SQL queries.
    |
    */

    'dblisten' => (bool) env('DB_LISTEN', false),
